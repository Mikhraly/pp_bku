...
#define	RS				6			// вывод индикатора  RS  (Команда(0)/Данные(1))
#define	E				7			// вывод индикатора  E   (Строб записи. Активное изменение с 1 на 0)
#define	HD44780_D4		1			// вывод индикатора  D4
#define	HD44780_D5		2			// вывод индикатора  D5
#define	HD44780_D6		3			// вывод индикатора  D6
#define	HD44780_D7		4			// вывод индикатора  D7
