...
void hd44780_init() {
	...
	hd44780_com(0b00111010);	// Установить разрядность интерфейса
	hd44780_com(0b00111010);	// Установить разрядность интерфейса
	hd44780_com(0b00111010);	// Установить разрядность интерфейса
	hd44780_com(0b00101010);	// Установить разрядность интерфейса
	hd44780_com(0b00101010);	// Установка параметров
	hd44780_com(0b00001000);	// Выключение дисплея
	hd44780_com(0b00000001);	// Очистка дисплея
	hd44780_com(0b00000110);	// Установка режима ввода данных
	hd44780_com(0b00001100);	// Включение дисплея
	*/
	// Своя инициализация
	_delay_ms(40);
